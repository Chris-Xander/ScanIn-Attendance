...
function Landing() {
  ...
  useEffect(() => {
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting) {
          ...
          if (entry.target === featuresRef2.current) setAnimateFeatures(true);
    ...
    if (featuresRef2.current)
      observer.observe(featuresRef2.current);
          ...
          <div className="features-list">
            {[
              ...
              <div 
                ...
                >
                   <div ref={featuresRef2} className="features-trigger" />
                  <h3>{feature.title}</h3>
