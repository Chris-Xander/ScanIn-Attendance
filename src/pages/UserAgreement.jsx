    ...
    return (
        <div className="user-agreement-main">
            <div className="user-agreement-header">
                <h1>User Agreement / Terms of Use for KansoCheckin (Attendid)</h1>
            ...
            <div className="user-agreement-content">
                <section>
                    ...
                    <p>Welcome to KansoCheckin (also known as Attendid) ("KansoCheckin," "we," "our," or "us"). We are pleased to provide you with access to our comprehensive attendance tracking platform designed to streamline attendance management for organizations, educational institutions, and event coordinators.</p>
                    <p>These Terms of Use ("Terms," "Agreement," or "Terms of Service") constitute a legally binding agreement between you (the "User," "you," or "your") and KansoCheckin, governing your access to and use of the KansoCheckin web application, progressive web app, mobile-responsive interface, and all related services, features, tools, and functionalities (collectively referred to as the "Service").</p>
                    ...
                    <p>This Agreement represents the entire understanding between you and KansoCheckin regarding the subject matter hereof and supersedes all prior agreements, understandings, or representations, whether written or oral, relating to such subject matter.</p>
                </section>

                <section>
                    <h2>Description of Service</h2>
                    <p>KansoCheckin (also known as Attendid) is a comprehensive, cloud-based attendance tracking and management platform designed to revolutionize how organizations, educational institutions, corporations, non-profit organizations, and event coordinators handle attendance recording, verification, and reporting. Our platform combines cutting-edge technology with user-friendly interfaces to provide a seamless attendance management experience.</p>
                ...
                <section>
                    ...
                    <p>If you are using KansoCheckin as part of a school, company, or event, your access may be governed by that organization's policies.</p>
                </section>

                <section>
                    <h2>User Accounts</h2>
                    <p>Certain features and functionalities of the KansoCheckin Service require the creation and maintenance of user accounts. Account registration enables personalized access, role-based permissions, and secure data management across sessions and organizations.</p>
                    ...
                    <p><strong>Account Types and Permissions:</strong> KansoCheckin supports various account types with different permission levels:</p>
                    <ul>
                ...
                <section>
                    ...
                    <p>Your use of the KansoCheckin Service is subject to specific acceptable use guidelines designed to maintain system integrity, protect user privacy, ensure fair access, and comply with applicable laws and regulations. These guidelines apply to all users, regardless of their role or organizational affiliation.</p>
                    ...
                    <ul>
                        ...
                        <li><strong>Security Bypass Attempts:</strong> Attempt to circumvent, bypass, disable, or interfere with any security measures, authentication protocols, verification processes, geofencing restrictions, device validation mechanisms, or other protective controls implemented by KansoCheckin</li>
                        ...
                        <li><strong>Impersonation:</strong> Impersonate any person or entity, including KansoCheckin staff, other users, or representatives of organizations; create false accounts or misrepresent your affiliation with any organization</li>
                        <li><strong>Commercial Exploitation:</strong> Use the Service for commercial purposes without explicit written permission from KansoCheckin, including but not limited to reselling access, using the Service as part of a commercial product, or competing directly with KansoCheckin</li>
                    </ul>
                    ...
                    <p><strong>Monitoring and Enforcement:</strong> KansoCheckin reserves the right to monitor usage patterns, investigate suspected violations, and take appropriate action including but not limited to account suspension, data removal, or legal action. We may also implement technical measures to detect and prevent prohibited activities.</p>
                    <p><strong>Reporting Violations:</strong> If you become aware of any violation of these acceptable use guidelines, you agree to promptly report it to KansoCheckin through the designated channels.</p>
                </section>

                <section>
                    <h2>Attendance Integrity</h2>
                    <p>KansoCheckin may use tools such as:</p>
                    <ul>
                ...
                <section>
                    ...
                    <p>Organizations and administrators using KansoCheckin may:</p>
                    <ul>
                    ...
                    <p>KansoCheckin is not responsible for how administrators configure or interpret attendance data.</p>
                </section>

                <section>
                    <h2>Intellectual Property</h2>
                    <p>All KansoCheckin software, branding, and content are owned by or licensed to KansoCheckin.</p>
                    <p>Users may not:</p>
                    <ul>
                ...
                <section>
                    ...
                    <p>By using KansoCheckin, you acknowledge that data is processed as described in that policy.</p>
                </section>

                <section>
                    <h2>Limitation of Liability</h2>
                    <p>To the fullest extent permitted by law, KansoCheckin is provided "as is."</p>
                ...
                <section>
                    ...
                    <p>You agree to indemnify and hold KansoCheckin harmless from claims arising from:</p>
                    <ul>
